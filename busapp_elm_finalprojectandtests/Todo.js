...
var $author$project$Todo$viewValidation = function (model) {
	return ((model.task_name === '') || ((model.description === '') || ((model.notes === '') || ((model.category === '') || ((model.priority === '') || (model.status === '')))))) ? A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('Please Fill All Fields!')
			])) : A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$elm$html$Html$text('All Fields Filled. You Can Submit!')
			]));
};
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$for('chk')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('To-Do List Form')
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
...
var $author$project$Todo$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Todo$init, update: $author$project$Todo$update, view: $author$project$Todo$view});
